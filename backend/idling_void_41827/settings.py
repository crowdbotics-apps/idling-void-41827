"""
Django settings for idling_void_41827 project.
...
ROOT_URLCONF = 'idling_void_41827.urls'
...
WSGI_APPLICATION = 'idling_void_41827.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "idling_void_41827 API",
    "DESCRIPTION": "API documentation for idling_void_41827 App",
    "VERSION": "v1",
}
